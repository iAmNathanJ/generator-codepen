...
[![Build Status](https://secure.travis-ci.org/iAmNathanJ/generator-codepen.png?branch=master)](https://travis-ci.org/iAmNathanJ/generator-codepen)

**Use Yeoman to set up a fast local development environment for playing with ideas or learning.**

Generator-codepen is currently being developed. It's purpose is to [Jekyll](http://jekyllrb.com/) static site generator in a [Yeoman](http://yeoman.io/) development workflow. Scaffold your site with Yo, manage front end packages with [Bower](http://bower.io/), and automate development and build tasks with [Grunt](http://gruntjs.com/). 
...
To install generator-codepen from npm, run:
